...
Please follow this documentation if you are using <em>nimbleShop</em> . If you are developing <em>nimbleshop</em> then follow "setting up development environment":http://nimbleshop.org/setting_up_development_environment.html .
